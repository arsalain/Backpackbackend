...
router.post("/createtrek",upload.fields([{name: 'testimage'}, { name: 'coverimage' }, {name : "planimg1"}, {name : "planimg2"}, {name : "planimg3"}, {name : "planimg4"}, {name : "planimg5"}, {name : "planimg6"}, {name : "planimg7"}, {name : "planimg8"} , {name : "planimg9"}, {name : "planimg10"},{name : "similarimg1"} , {name : "similarimg2"}, {name : "similarimg3"} ,{name : "reviewimg1"} , {name : "reviewimg2"}, {name : "reviewimg3"}   ] ),createTrek);
